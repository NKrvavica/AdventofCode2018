...
def parse_input(fname, N, T):
    ...
    collection_area = np.zeros((N + 2, N + 2))
    collection_area[1: -1, 1: -1] = initial
...
final_area = collection_area[1: -1, 1: -1]
